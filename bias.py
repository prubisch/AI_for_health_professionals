...
bias_page = ui.page_fluid(
    ui.navset_card_tab(
        ...
        ui.HTML("<p>Wenn die Daten selber Korrelationen beinhalten, die z.B. durch die Messungstechnik entstehen, also 3. Quellen können KI-Systeme diese identifizieren bzw. ausnutzen. Man spricht auch von <i>short-cut learning</i>, da Zusammenhänge erlernt wernde, die nicht von den Daten selber unstützt werden. Diese unbeabsichtigen Korrelationen nennt man <b>Bias</b>. </p>"),
        ...
        ui.HTML("<p> Wie schätzen Sie diese Performance ein (z.B. im Vergleich zum Zufallsniveau)? Woran könnte es liegen dass Hunge zu 26 % als Katzen misklassifiziert werden? </p>"), 
