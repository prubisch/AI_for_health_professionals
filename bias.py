...
bias_page = ui.page_fluid(
    ui.navset_card_tab(
        ...
        ui.br(),
        ui.br(),
        ui.HTML("<p style='margin-top: -200px;'><i>Wie schätzen Sie diese Menge an Trainingsdaten ein? Ist das viel oder wenig für die 10 Klassen von natürlichen Bildern? </i></p>"),
        ui.br(), ui.br(),
        ...
        ui.br(),
        ui.br(),
        ui.HTML("<p style='margin-top: -200px;'> Nutzen Sie den Schieber um sich 5 weitere Beispielbilder einer bestimmten Klasse anzeigen zu lassen. Finden Sie eine nichtkausale Korrelation zwischen den Bildern?</p>"), 
